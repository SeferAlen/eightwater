...
export const routeTransitionAnimations = trigger('triggerName', [
	transition('One => Two, One => Three, One => Four, Two => Three, Two => Four, Three => Four, Four => One', [
	...
	transition('Four => Three, Four => Two, Four => One, Three => Two, Three => One, Two => One, One => Four', [
		style({ position: 'relative' }),
		query(':enter, :leave', [
			style({
				position: 'absolute',
